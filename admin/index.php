            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../foto/<?php echo"$k_k[gambar]";?>" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../foto/<?php echo"$k_k[gambar]";?>" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
              <p>SELAMAT DATANG</p>
              <a href="index.php"><i class="fa fa-circle text-success"></i><?php echo"$k_k[nama_app]";?></a>
            </div>
          </div>
          <!-- search form -->
