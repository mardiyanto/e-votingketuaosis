          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="osis.php?aksi=home">Quik Count</a></li>
                <li><a href="osis.php?aksi=home">Selamat datang <?=$_SESSION['nama_pemilih'] ?></a></li>
...
?>
      ...
      <footer class="main-footer">
        <div class="container">
          ...
          <strong>Copyright &copy; 2014-2015 <a href="http://sukait.com">osis</a>.</strong> All rights reserved.
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
