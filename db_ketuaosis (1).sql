...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2024 at 06:31 AM
...
(5, 'AKABEST', '1709111256_almira.png', '', '', '', '', '', '', '44569017798372113322236485500047');
...
INSERT INTO `suara` (`id_suara`, `id_pemilih`, `id_paslon`, `suara_sah`, `suara_rusak`) VALUES
(1, 1, 2, '1', ''),
(2, 1, 2, '1', ''),
(3, 1, 2, '1', ''),
(4, 1, 1, '1', ''),
...
--
ALTER TABLE `paslon`
  MODIFY `id_paslon` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `suara`
  MODIFY `id_suara` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
